 ...
 * Backward-Compatible UIs</a> to ensure that devices running any version of ndroid OS are supported.
 * More specifically, there are separate implementations of this abstract class: for newer devices,
 * {@link #getInstance} will return a {@link SystemUiHiderHoneycomb} instance, while on older devices
 * {@link #getInstance} will return a {@link SystemUiHiderBase} instance.
 * <p>
...
public abstract class SystemUiHider {
     ...
     * flag will be set on older devices, making the status bar "float" on top of the activity layout.
     * This is most useful when there are no controls at the top of the activity layout.
     * <p>
     * This flag isn't used on newer devices because the <a
     * href="http://developer.android.com/design/patterns/actionbar.html">action bar</a>, the most
     * important structural element of an Android app, should be visible and not obscured by the system
     * UI.
     */
    ...
    /**
     * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the
     * navigation bar, if it's present on the device and the device allows hiding it. In cases where the
     * navigation bar is present but cannot be hidden, show and hide will toggle low profile mode.
     */
     ...
     * object will be either a {@link SystemUiHiderBase} or {@link SystemUiHiderHoneycomb} depending on
     * the device.
     * 
